...
public class RecipeService {
    ...
    public RecipeService(RecipeRepository repository, SearchService searchService, WebClient.Builder webClientBuilder, @Value("${recipes.datasource.url}") String externalUrl) {
    ...
    public int loadFromExternal() {
        try {
            ...
            // Null type safety warning suppressed: payload is checked for null below
            ...
            throw new RuntimeException("Failed to load recipes from external datasource: " + e.getMessage(), e);
        }
    }
}
